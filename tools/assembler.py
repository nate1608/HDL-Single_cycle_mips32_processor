...
OPCODES = {
    ...
    'beqz':  '001110', 'hlt':   '111111', 'jump':  '001111', 'jr': '010000'
}
...
def assemble(input_file='C:/Users/ASUS/visual code/Assembler/function.asm', output_file='C:/Users/ASUS/visual code/Assembler/program.hex'):
    """
    ...
    with open(input_file, 'r') as f_in, open(output_file, 'w') as f_out:
        for line in f_in:
            ...
            # Jump Type: jump <address>
                ...
                rs_bin = '00000'
                rt_bin = '00000'
                imm_bin = signed_imm_to_bin(tokens[1],26)
                machine_code_bin = opcode_bin + imm_bin

            # jr Type: jr <register containing addr>
            elif op =='jr':
                rs_bin = reg_to_bin(tokens[1])
                rt_bin = '00000'
                imm_bin = '0'*16
